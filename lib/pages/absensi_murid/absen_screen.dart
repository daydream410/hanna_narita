...
class ABsensiMurid extends StatefulWidget {
  const ABsensiMurid({super.key});

  @override
  State<ABsensiMurid> createState() => _ABsensiMuridState();
}

class _ABsensiMuridState extends State<ABsensiMurid> {
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  if (snapshot.data!.docs[index]['absen3'] !=
                                      null) {
                                    isVisible = false;
                                  }
                                  if (snapshot.data!.docs[index]['absen1'] ==
                                      null) {
                                    absen = 1;
                                  ...
                                  print(absen);
                                  print(docId);
                                  Get.toNamed(RouteName.detailAbsen,
                                      arguments: [docId, isVisible, absen]);
                                },
                                child: Card(
                                  elevation: 5,
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '${snapshot.data!.docs[index]['tipekelas']} (${snapshot.data!.docs[index]['jumlahsesi'].toString()}x Sesi)',
                                              style: const TextStyle(
                                                fontWeight: FontWeight.w500,
                                                fontSize: 14,
                                              ),
