...
class LunasList extends StatefulWidget {
  const LunasList({super.key});

  @override
  State<LunasList> createState() => _LunasListState();
}

class _LunasListState extends State<LunasList> {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Daftar Murid Full Payment (Lunas)',
                style: TextStyle(
                  fontSize: 18,
