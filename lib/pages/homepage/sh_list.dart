...
class SelfHairdoList extends StatefulWidget {
  const SelfHairdoList({super.key});

  @override
  State<SelfHairdoList> createState() => _SelfHairdoListState();
}

class _SelfHairdoListState extends State<SelfHairdoList> {
