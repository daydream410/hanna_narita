...
class SelfMakeupList extends StatefulWidget {
  const SelfMakeupList({super.key});

  @override
  State<SelfMakeupList> createState() => _SelfMakeupListState();
}

class _SelfMakeupListState extends State<SelfMakeupList> {
